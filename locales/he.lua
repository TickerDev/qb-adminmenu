local Translations = {
    error = {
        blips_deactivated = 'בליפים הושבתו',
        names_deactivated = 'שמות הושבתו',
        changed_perm_failed = '!בחר קבוצה',
        missing_reason = '!אנא כלול סיבה',
        invalid_reason_length_ban = '!אתה חייב לתת סיבה ואורך לבאן',
        no_store_vehicle_garage = '...אתה לא יכול לשים רכב בגראז\' הזה',
        no_vehicle = '..אתה לא ברכב',
        no_weapon = '..אתה לא מחזיק נשק',
        no_free_seats = '!אין מושבים פנויים ברכב זה',
        failed_vehicle_owner = '..רכב זה כבר שלך',
        not_online = 'השרת הזה לא מחובר',
        no_receive_report = 'אתה לא מקבל דיווחים',
        failed_set_speed = 'לא בחרת מהירות.. (`fast` בשביל ריצה מהירה, `normal` למהירות רגילה)', -- You did not set a speed.. (`fast` for super-run, `normal` for normal)
        failed_set_model = '..לא הצבת מודל',
        failed_entity_copy = '!אין מידע על ישות freeaim להעתקה ללוח',
    },
    success = {
        blips_activated = 'בליפים הופעלו',
